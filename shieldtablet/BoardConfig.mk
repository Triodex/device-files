...
TARGET_KERNEL_CROSS_COMPILE_PREFIX := arm-architoolchain-linux-gnueabihf-
BOARD_KERNEL_CMDLINE := vpr_resize androidboot.selinux=permissive vmalloc=300M
TARGET_KERNEL_SOURCE := kernel/nvidia/shield
TARGET_KERNEL_CONFIG := lineage_shieldtablet_defconfig
